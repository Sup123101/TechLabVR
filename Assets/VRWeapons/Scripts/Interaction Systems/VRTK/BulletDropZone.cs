...
namespace VRWeapons.InteractionSystems.VRTK
{
    ...
    public class BulletDropZone : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (bolt == null && thisWeapIfInternal != null)
            {
                bolt = thisWeapIfInternal.GetComponentInChildren<IBoltActions>();
            }
        ...
        bool IsMagazineFull()
        {
            ...
            if (thisMag.GetCurrentRoundCount() >= thisMag.MagazineCapacity())
            {
                ret = true;
            }
            return ret;
